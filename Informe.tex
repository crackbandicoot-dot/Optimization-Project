...
Se generaron 300 experimentos de forma aleatoria, con configuraciones dadas en función de los siguientes parámetros \textbf{learning rate},\textbf{tolerance},\textbf{max iterations} y 
\textbf{start point}.
